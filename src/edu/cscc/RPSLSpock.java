...
public class RPSLSpock {
     ...
     * @author- Ahmed Aljumaili
     *choice valid pick
     * @param pick the valuse that the user will write it i the program
     * @return if the pick value is valid return true
     */
    ...
    /**
     * @author- Ahmed Aljumaili
     * @return This method Will pick one of the options randomly like(rock,paper..ets)
     */
    ...
    /**
     * @author- Ahmed Aljumaili
     * @param c_pick here the computer will pick a value
     * @param h_pick the value that the user will pick
     * @return if the computer wins it will return true otherwise it will return false
     */
